...
This repository is a fork of [agentsmill/age-of-agents](https://github.com/agentsmill/age-of-agents) maintained by **OneByJorah**.

**Changes from upstream:**
- Added `.env.example` with server and session source configuration
- Dockerfiles already present in `packages/server/` and `packages/client/`
